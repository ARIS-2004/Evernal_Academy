...
export default function DaycarePage() {
  const programme = getProgrammeById('daycare');
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FFFFFF' }}>
        ...
        <div className="relative px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
                <p className="text-sm text-[#B2C6BD]">Hours</p>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#08472C] mb-6">Child Care Excellence</h2>
        ...
        {/* Key Areas */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#08472C] mb-6">What We Provide</h2>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#08472C] mb-6">Special Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {/* Kidzee Sessions */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#08472C] mb-6">Daily Schedule</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {/* Activities */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#08472C] mb-6">Parent Communication & Updates</h2>
        ...
        {/* Photo Gallery */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#08472C] mb-6">Daycare Facilities Gallery</h2>
        ...
        {/* Video Section */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#08472C] mb-6">Daycare Experience Videos</h2>
        ...
        <section className="bg-gradient-to-r from-[#08472C] to-[#0F172A] rounded-lg p-8 sm:p-12 text-white text-center">
          ...
          <p className="text-lg text-[#B2C6BD] mb-8">Providing safe, nurturing care with developmental excellence!</p>
          <Link
            href="/enroll"
