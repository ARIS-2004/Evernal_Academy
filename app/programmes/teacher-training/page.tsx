...
export default function TeacherTrainingPage() {
  const programme = getProgrammeById('teacher-training');
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FFFFFF' }}>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
                <p className="text-sm text-[#B2C6BD]">Category</p>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#08472C] mb-6">Educator Growth & Expertise</h2>
        ...
        {/* Key Areas */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#08472C] mb-6">Key Areas of Focus</h2>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#08472C] mb-6">Training Modules</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {/* Kidzee Sessions */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#08472C] mb-6">Programme Structure</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {/* Activities */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#08472C] mb-6">Professional Development</h2>
        ...
        {/* Photo Gallery */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#08472C] mb-6">Training Gallery</h2>
        ...
        {/* Video Section */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#08472C] mb-6">Training Videos</h2>
        ...
        <section className="bg-gradient-to-r from-[#08472C] to-[#0F172A] rounded-lg p-8 sm:p-12 text-white text-center">
          <h2 className="text-3xl font-bold mb-4">Become a Certified Educator</h2>
          <p className="text-lg text-[#B2C6BD] mb-8">Join our training programme and develop your expertise in early childhood education!</p>
          <Link
            href="/enroll"
